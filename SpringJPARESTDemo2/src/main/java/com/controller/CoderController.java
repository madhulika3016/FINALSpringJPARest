...
public class CoderController 
{
	...
	public Coder getCoderByName(@PathVariable String cname)
	{
		Coder c1=coderservice.getCoderByName(cname);
		return c1;
	}
	...
	public ResponseEntity<List<Coder>> getCoders()
	{
		...
		ResponseEntity<List<Coder>> re=new ResponseEntity<List<Coder>>(lc,HttpStatus.OK);
		return re;
	}
